...
# Real World Use
**Mapp** is more so a component program that can be used in combination with other programs to serve a more practical real life purpose. **Mapp** doesn't currently have a command to return the colour of the clump, but it does store the colour of the country